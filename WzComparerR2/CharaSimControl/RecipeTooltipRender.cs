...
namespace WzComparerR2.CharaSimControl
{
    public class RecipeTooltipRender : TooltipRender
    {
        ...
        private Bitmap RenderRecipe(out int picH)
        {
            ...
            g.DrawString("制作结果", GearGraphics.ItemDetailFont, GearGraphics.GreenBrush2, 13, picH);
            picH += 16;
            ...
            g.DrawString("制作材料", GearGraphics.ItemDetailFont, GearGraphics.GreenBrush2, 13, picH);
            picH += 16;
