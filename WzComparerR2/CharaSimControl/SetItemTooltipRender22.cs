    ...
    public class SetItemTooltipRender22 : TooltipRender
    {
        ...
        private Bitmap RenderSetItem(bool specialPetSetEffectName, out int picHeight)
        {
            ...
            else
            {
                ...
                {
                    TextRenderer.DrawText(g, "(无)", GearGraphics.EquipMDMoris9Font, new Point(14, picHeight), ((SolidBrush)GearGraphics.Equip22BrushGray).Color, TextFormatFlags.NoPadding);
                    GearGraphics.DrawString(g, "未装备", GearGraphics.EquipMDMoris9Font, new Dictionary<string, Color>() { { string.Empty, ((SolidBrush)GearGraphics.Equip22BrushGray).Color } }, 30, 283, ref picHeight, 15, Text.TextAlignment.Right);
                }
            }
