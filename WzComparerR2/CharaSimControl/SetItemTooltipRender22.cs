...
namespace WzComparerR2.CharaSimControl
{
    public class SetItemTooltipRender22 : TooltipRender
    {
        ...
        private Bitmap RenderSetItem(bool specialPetSetEffectName, out int picHeight)
        {
            ...
            TextRenderer.DrawText(g, this.SetItem.SetItemName, Translator.IsKoreanStringPresent(this.SetItem.SetItemName) ? GearGraphics.EquipMDMoris9Font : GearGraphics.EquipDetailFont, new Point(46, picHeight), Color.White, TextFormatFlags.NoPadding);
                ...
                foreach (var setItemPart in this.SetItem.ItemIDs.Parts)
                {
                    ...
                    */
                    ...
                    if (!partNames.Contains(itemName + typeName))
                    {
                        ...
                        if (!cash)
                        {
                            int typeWidth = TextRenderer.MeasureText(g, typeName, Translator.IsKoreanStringPresent(Compact(g, typeName, 200)) ? GearGraphics.EquipMDMoris9Font : GearGraphics.EquipDetailFont, new Size(int.MaxValue, int.MaxValue), TextFormatFlags.NoPadding).Width;
                            TextRenderer.DrawText(g, typeName, Translator.IsKoreanStringPresent(Compact(g, typeName, 200)) ? GearGraphics.EquipMDMoris9Font : GearGraphics.EquipDetailFont, new Point(14, picHeight), ((SolidBrush)brush).Color, TextFormatFlags.NoPadding);
                            TextRenderer.DrawText(g, Compact(g, itemName, 200), Translator.IsKoreanStringPresent(Compact(g, itemName, 200)) ? GearGraphics.EquipMDMoris9Font : GearGraphics.EquipDetailFont, new Point(90, picHeight), ((SolidBrush)brush).Color, TextFormatFlags.NoPadding);
                            picHeight += 15;
                        }
                        else
                        {
                            ...
                            int typeWidth = TextRenderer.MeasureText(g, typeName, Translator.IsKoreanStringPresent(typeName) ? GearGraphics.KMSItemDetailFont2 : GearGraphics.EquipDetailFont, new Size(int.MaxValue, int.MaxValue), TextFormatFlags.NoPadding).Width;
                            TextRenderer.DrawText(g, Compact(g, itemName, 261 - 10 - typeWidth - 52), Translator.IsKoreanStringPresent(itemName) ? GearGraphics.KMSItemDetailFont2 : GearGraphics.EquipDetailFont, new Point(60, picHeight), ((SolidBrush)brush).Color, TextFormatFlags.NoPadding);
                            GearGraphics.DrawString(g, typeName, Translator.IsKoreanStringPresent(typeName) ? GearGraphics.KMSItemDetailFont2 : GearGraphics.EquipDetailFont, new Dictionary<string, Color>() { { string.Empty, ((SolidBrush)GearGraphics.Equip22BrushGray).Color } }, 30, 283, ref picHeight, 0, Text.TextAlignment.Right);
            ...
            else
            {
                ...
                {
                    TextRenderer.DrawText(g, "(无)", GearGraphics.EquipDetailFont, new Point(14, picHeight), ((SolidBrush)GearGraphics.Equip22BrushGray).Color, TextFormatFlags.NoPadding);
                    GearGraphics.DrawString(g, "未装备", GearGraphics.EquipDetailFont, new Dictionary<string, Color>() { { string.Empty, ((SolidBrush)GearGraphics.Equip22BrushGray).Color } }, 30, 283, ref picHeight, 15, Text.TextAlignment.Right);
                }
            }
        ...
        {
            Size s = TextRenderer.MeasureText(g, text, Translator.IsKoreanStringPresent(text) ? GearGraphics.EquipMDMoris9Font : GearGraphics.EquipDetailFont, new Size(int.MaxValue, int.MaxValue), TextFormatFlags.NoPadding);
            ...
            while (seg > 1)
            {
                ...
                s = TextRenderer.MeasureText(g, tst, Translator.IsKoreanStringPresent(tst) ? GearGraphics.EquipMDMoris9Font : GearGraphics.EquipDetailFont, new Size(int.MaxValue, int.MaxValue), TextFormatFlags.NoPadding);
        ...
        private void RenderEffect(Graphics g, bool specialPetSetEffectName, ref int picHeight)
        {
            foreach (KeyValuePair<int, SetItemEffect> effect in this.SetItem.Effects)
            {
                ...
                {
                    effTitle = $"{Regex.Replace(this.SetItem.SetItemName, " 套装$", "")} {effect.Key}套装效果";
                }
                else
                {
                    effTitle = effect.Key + "套装效果";
                }
                if (Translator.IsKoreanStringPresent(effTitle))
                {
                ...
                foreach (KeyValuePair<GearPropType, object> prop in props)
                {
                    if (prop.Key == GearPropType.Option)
                    {
                        ...
                        {
                            GearGraphics.DrawString(g, p.ConvertSummary(), Translator.IsKoreanStringPresent(p.ConvertSummary()) ? GearGraphics.KMSItemDetailFont2 : GearGraphics.EquipDetailFont, new Dictionary<string, Color>() { { string.Empty, color } }, 14 + dx, 290, ref picHeight, 15);
                        }
                    }
                    else if (prop.Key == GearPropType.OptionToMob)
                    {
                        ...
                        {
                            GearGraphics.DrawPlainText(g, p.ConvertSummary(), Translator.IsKoreanStringPresent(p.ConvertSummary()) ? GearGraphics.KMSItemDetailFont2 : GearGraphics.EquipDetailFont, color, 14 + dx, 290, ref picHeight, 15);
                        }
                    }
                    ...
                    else if (prop.Key == GearPropType.bonusByTime)
                    {
                        ...
                        {
                            GearGraphics.DrawPlainText(g, $"{p.TermStart}小时后", GearGraphics.EquipDetailFont, color, 10, 290, ref picHeight, 15);
