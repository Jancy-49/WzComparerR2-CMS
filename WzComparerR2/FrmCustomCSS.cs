...
namespace WzComparerR2
{
    public partial class FrmCustomCSS : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void colorPickers_SelectedColorChanged(object sender, EventArgs e)
        {
            ...
            var contents = new[]
            {
                new {Text = "超链接" + Environment.NewLine, Fore = hyperlinkColor, Back = backgroundColor, Underline = true},
                new {Text = "默认文本" + Environment.NewLine, Fore = normalTextColor, Back = backgroundColor, Underline = false},
                new {Text = "变更内容文本" + Environment.NewLine, Fore = changedTextColor, Back = changedBackgroundColor, Underline = false},
                new {Text = "新增内容文本" + Environment.NewLine, Fore = addedTextColor, Back = addedBackgroundColor, Underline = false},
                new {Text = "删除内容文本", Fore = removedTextColor, Back = removedBackgroundColor, Underline = false}
            };
