...
namespace WzComparerR2.MapRender
{
    public static class SummonPreset
    {
        ...
        {
            [220080100] = new List<string> { "时间球", "时间裂缝", "异界的帕普拉图斯" },
            [220080200] = new List<string> { "时间球", "时间裂缝", "异界的帕普拉图斯" },
            [220080300] = new List<string> { "时间球", "时间裂缝", "异界的帕普拉图斯" },

            [410007140] = new List<string> { "卡琳第1阶段穷奇" },
            [410007180] = new List<string> { "卡琳第1阶段梼杌" },
            [410007220] = new List<string> { "卡琳第1阶段混沌" },
            [410007260] = new List<string> { "卡琳第2阶段" },
            [410007300] = new List<string> { "卡琳第3阶段全部怪物", "卡琳第3阶段仅凶兽" },

            [410008040] = new List<string> { "卡琳第1阶段穷奇" },
            [410008080] = new List<string> { "卡琳第1阶段梼杌" },
            [410008120] = new List<string> { "卡琳第1阶段混沌" },
            [410008160] = new List<string> { "卡琳第2阶段" },
            [410008200] = new List<string> { "卡琳第3阶段全部怪物", "卡琳第3阶段仅凶兽" },

            [410008340] = new List<string> { "卡琳第1阶段穷奇" },
            [410008380] = new List<string> { "卡琳第1阶段梼杌" },
            [410008420] = new List<string> { "卡琳第1阶段混沌" },
            [410008460] = new List<string> { "卡琳第2阶段" },
            [410008500] = new List<string> { "卡琳第3阶段全部怪物", "卡琳第3阶段仅凶兽" },

            [410008640] = new List<string> { "卡琳第1阶段穷奇" },
            [410008680] = new List<string> { "卡琳第1阶段梼杌" },
            [410008720] = new List<string> { "卡琳第1阶段混沌" },
            [410008760] = new List<string> { "卡琳第2阶段" },
            [410008800] = new List<string> { "卡琳第3阶段全部怪物", "卡琳第3阶段仅凶兽" },
        };
