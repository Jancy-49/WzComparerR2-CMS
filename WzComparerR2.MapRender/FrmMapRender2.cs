        ...
        private async void ChatCommand(string command)
        {
            ...
            switch (arguments[0].ToLower())
            {
                ...
                case "/minimap":
                    ...
                    {
                        case "list":
                            this.ui.ChatBox.AppendTextHelp($"小地图: {string.Join(", ", canvasList?.Keys)}");
                            break;
                    ...
                    switch (arguments.ElementAtOrDefault(1))
                    {
                        case "list":
                            if (!string.IsNullOrEmpty(this.mapData.Bgm))
                            {
                                ...
                                this.ui.ChatBox.AppendTextHelp($"Multi BGM个数: {subNodes.Count}");
                            ...
                            {
                                this.ui.ChatBox.AppendTextHelp($"Multi BGM个数: 0");
                            }
                            break;
                        ...
                        case "set":
                            ...
                            {
                                this.ui.ChatBox.AppendTextHelp($"请输入正确的Multi BGM。");
                            }
                            break;
