...
namespace WzComparerR2.LuaConsole
{
    public partial class FrmConsole : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void FrmConsole_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                if (DialogResult.Yes != MessageBoxEx.Show(this, "存在进行中的程序。是否要结束？", "警告", MessageBoxButtons.YesNo, MessageBoxIcon.Warning))
                {
                    e.Cancel = true;
                    return;
                }
        ...
        private void menuReset_Click(object sender, EventArgs e)
        {
            ...
            {
                ToastNotification.Show(this, "存在运行中的程序。", 1000, eToastPosition.TopCenter);
                return;
            }
            ...
            {
                MessageBoxEx.Show(this, "当前选择的文本不存在。", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private async void menuRun_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.env.WriteLine("执行: {0}...", selectedEditor.BaseFileName);
        ...
        private void menuStopRun_Click(object sender, EventArgs e)
        {
            ...
            {
                this.cancellationTokenSource.Cancel();
                ToastNotification.Show(this, "正在执行中...", 1000, eToastPosition.TopCenter);
            }
        }
        ...
        private bool SaveFile(FrmLuaEditor editor, bool saveAs = false)
        {
            ...
            this.env.WriteLine($"===={editor.FileName} 保存完成====");
            return true;
        }
        ...
        private void OpenFile(string fileName)
        {
            ...
            {
                MessageBoxEx.Show(this, ex.ToString(), "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void FrmLuaEditor_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                switch(MessageBoxEx.Show(this, "关闭窗口时未保存的变更内容消失。是否要保存？", "警告", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning))
                {
